...
# Defining Tokens
tokens = ('BEGIN', 'END', 'OPENH2', 'CLOSEH2', 'OPENH3', 'CLOSEH3', 'OPENTABLE', 'CLOSETABLE', 'GARBAGE', 'CONTENT')
t_ignore = '\t'
...
def p_handletext(p):
    '''handletext : handleheader handlecontent handletext
                  | handleheader OPENTABLE skiptag CLOSETABLE handlecontent handletext
                  | empty 
    '''
...
def main():
    global data
    hyperlinks = ['https://en.wikipedia.org/wiki/Timeline_of_the_COVID-19_pandemic_in_Malaysia_(2020)',
    ...
    filename = ['Malaysia_2020.txt','Malaysia_2021.txt', 'Malaysia_2022.txt', 'Malaysia_2023.txt', 'Malaysia_2024.txt']
